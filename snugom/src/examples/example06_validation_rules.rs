...
struct AdvancedEntity {
    ...
    #[snugom(validate(custom = "crate::examples::example06_validation_rules::ensure_not_admin"))]
    slug: String,
}
...
bundle! {
    ...
    entities: {
        Article => "articles",
        AdvancedEntity => "advanced",
    }
}

fn ensure_not_admin(value: &String) -> ValidationResult<()> {
    if value == "admin" {
