...
pub const ENTITY_FIND_SCRIPT_BODY: &str = include_str!("../../lua/entity_find.lua");
...
pub static ENTITY_GET_OR_CREATE_SCRIPT: LazyLock<Script> =
    LazyLock::new(|| Script::new(ENTITY_GET_OR_CREATE_SCRIPT_BODY));
pub static ENTITY_FIND_SCRIPT: LazyLock<Script> = LazyLock::new(|| Script::new(ENTITY_FIND_SCRIPT_BODY));
